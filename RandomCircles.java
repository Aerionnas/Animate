...
public class RandomObjects extends JPanel implements ActionListener {
    ...
    public void drawFrame(Graphics g, int frameNumber, int width, int height) {
        ...
        Color or= new Color (255,153,51);
        Color bl= new Color (0, 128, 255);
        Color nu= new Color (153,0,0);
        setForeground(or);
        Font tr = new Font("TimesRoman", Font.PLAIN, 12+frameNumber%20);
        g.setFont(tr);
        g.drawString("Aerionna Stephenson's PA01 Project!!!",10,500);
        int centerX;
        int centerY;
        int colorC;
        int count;
        ...
        for (count=0; count< 1; count++)
        {
          ...
          switch (colorC) {
            ...
            g.fillRect( 150, 150,width/6, height/6 );
            g.setColor(Color.BLUE);
            g.drawRect( 150, 150,width/6, height/6 );
            break;

            case 1:
            g.setColor(bl);
            g.fillOval( centerX - 50, centerY - 50, 25, 25 );
            g.setColor(Color.yellow);
            g.drawOval( centerX - 50, centerY - 50, 25, 25);
            g.fillRect( 150, 150,width/6, height/6 );
            g.setColor(Color.yellow);
            g.drawRect( 150, 150,width/6, height/6 );
            ...
            case 2:
            g.setColor(nu);
            g.fillOval( centerX - 50, centerY - 50, 50, 50 );
            g.setColor(Color.BLACK);
            g.drawOval( centerX - 50, centerY - 50, 50, 50 );
            g.setColor(Color.BLACK);
            g.fillRect( 150, 150,width/6, height/6 );
            g.setColor(Color.black);
            g.drawRect( 150, 150,width/6, height/6 );
            g.setColor(Color.magenta);
            g.fillOval( 0, 0,width/4, height/4 );
            g.setColor(Color.magenta);
            g.drawOval( 0, 0,width/4, height/4 );
            Font c = new Font("Courier", Font.PLAIN, 18+frameNumber%50);
            g.setFont(c);
            g.drawString("I hope that you like it ",10,400);
  ...
  //  }
    ...
    public static void main(String[] args) {
         ...
         */
        RandomObjects drawingArea = new RandomObjects();
         ...
         */
        Timer frameTimer = new Timer(500,drawingArea);
