 ...
 */
 ...
 //     g.drawRect( 50, 50,width/4, height/4 );
 //
 ...
 //          */
 //         RandomSquare square = new RandomSquare();
 //
 //         square.setBackground(Color.WHITE);
 //         window.setContentPane(square);
 //
 ...
 //          */
 //         square.setPreferredSize(new Dimension(500,500));
 //
 //         window.pack();
 ...
 //          */
 //         Timer frameTimer = new Timer(1000,square);
 //
...
public class RandomCircles extends JPanel implements ActionListener {
    ...
    public void drawFrame(Graphics g, int frameNumber, int width, int height) {
        ...
        g.fillRect( 200, 150,width/6, height/6 );
        g.setColor(Color.black);
        g.drawRect( 200, 150,width/6, height/6 );
        ...
        /*for (count = 0; count < 3; count++) {
          ...
          //  centerY = (int)(height*Math.random());
            ...
            g.setColor(Color.magenta);
            g.fillOval( 380, 0,width/4, height/4 );
            g.setColor(Color.magenta);
            g.drawOval( 380, 0,width/4, height/4 );
            g.setColor(Color.BLUE);
            g.fillOval(125, 300,width/2, height/4 );
            g.setColor(Color.blue);
            g.drawOval( 125,300,width/2, height/4 );
